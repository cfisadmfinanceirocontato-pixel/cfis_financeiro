...
CORRIGIDO: Erro 'Collection' object is not callable resolvido
"""
...
class MongoDB:
    ...
    @st.cache_resource
    def get_client():
        """Retorna o cliente MongoDB (NÃO o banco de dados)"""
    ...
    def testar_conexao():
        ...
        try:
            # CORREÇÃO: chama command no cliente, não no banco
            client = MongoDB.get_client()
            client.admin.command('ping')  # ✅ AGORA FUNCIONA!
